      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            (orderModel.createdAt != null) ? Text(
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            Expanded(
              child: Wrap(alignment: WrapAlignment.center, runAlignment: WrapAlignment.center, children: [
                ...
                (showEarning && (Get.find<ProfileController>().profileModel?.earnings ?? 0) == 1 && orderModel.originalDeliveryCharge != null && orderModel.dmTips != null) ? Text(
                  PriceConverterHelper.convertPrice((orderModel.originalDeliveryCharge ?? 0) + (orderModel.dmTips ?? 0)),
                  style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                ) : const SizedBox(),
                const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                (showEarning && (Get.find<ProfileController>().profileModel?.earnings ?? 0) == 1) ? Text(
